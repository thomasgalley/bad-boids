...
def test_initial_data():
   ...
   test_before=[[boid.xposition for boid in test.boids],[boid.yposition for boid in test.boids],[boid.xvelocity for boid in test.boids], [boid.yvelocity for boid in test.boids]] 
   for j in range (4):
       for i in range (50):
         assert_almost_equal(regression_data["before"][j][i],test_before[j][i],delta=0.01)
